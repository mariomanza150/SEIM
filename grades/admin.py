...
class GradeScaleAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("name", "code", "description", "country")}),
        (
            "Scale Configuration",
    ...
    def grade_count(self, obj):
        ...
        return format_html('<span style="font-weight: bold;">{}</span> grades', count)
...
class GradeValueAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Numeric Values", {"fields": ("numeric_value", "gpa_equivalent")}),
        (
            "Percentage Range (Optional)",
            {"fields": ("min_percentage", "max_percentage"), "classes": ("collapse",)},
        ),
        ("Status", {"fields": ("is_passing",)}),
        (
            "System Information",
            {"fields": ("id", "created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class GradeTranslationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Translation Mapping", {"fields": ("source_grade", "target_grade")}),
        ("Translation Details", {"fields": ("confidence", "notes", "created_by")}),
        ("GPA Analysis", {"fields": ("gpa_difference",), "classes": ("collapse",)}),
        (
            "System Information",
            {"fields": ("id", "created_at", "updated_at"), "classes": ("collapse",)},
        ),
    ...
    def gpa_difference(self, obj):
        ...
        return format_html(
            '<span title="Absolute difference in GPA equivalents">{:.3f}</span>', diff
        )
