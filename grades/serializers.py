...
class GradeTranslationSerializer(serializers.ModelSerializer):
    ...
    source_grade_label = serializers.CharField(
        source="source_grade.label", read_only=True
    )
    source_scale_code = serializers.CharField(
        source="source_grade.grade_scale.code", read_only=True
    )
    target_grade_label = serializers.CharField(
        source="target_grade.label", read_only=True
    )
