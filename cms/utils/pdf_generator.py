...
def generate_participation_form():
    ...
    story.append(
        Paragraph("Programa de Movilidad Internacional", styles["CustomHeading"])
    )
...
def generate_nomination_letter_template():
    ...
    story.append(
        Paragraph(
            "(Formato para Director de Facultad/Escuela)", styles["CustomHeading"]
        )
    )
    story.append(Spacer(1, 0.3 * inch))
    ...
    story.append(
        Paragraph("Sin más por el momento, quedo de usted.", styles["CustomBody"])
    )
    story.append(Spacer(1, 0.3 * inch))
    story.append(Paragraph("ATENTAMENTE", styles["CustomBody"]))
    story.append(Spacer(1, 0.8 * inch))
...
def generate_return_program_form():
    ...
    sections = [
        ...
        (
            ...
            "Describa su experiencia académica en la institución de acogida:",
        ),
        (
            "EXPERIENCIA CULTURAL",
            "Describa los aspectos culturales más relevantes de su experiencia:",
        ),
