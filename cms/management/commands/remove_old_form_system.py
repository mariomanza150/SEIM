...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            "4. Update exchange.models.Program.application_form to reference FormPage"
        )
        self.stdout.write(
            "5. Run: pip uninstall django-dynforms crispy-bootstrap5 django-crisp-modals django-itemlist"
        )
