...
- `/seim/preferences/` - SPA alias that redirects to `/seim/settings/`
...
Root leftovers (`/applications/`, `/applications/create/`, `/profile/`, `/calendar/`, `/documents/`, `/notifications/`, and related) redirect into these `/seim/` routes. See `documentation/notes/SPA_VS_LEGACY.md`.
