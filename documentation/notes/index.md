...
**Note:** This directory is the working-notes subtree of [`documentation/`](../README.md). How notes relate to manuals: [`notes/README.md`](README.md). `documents/` is a Django app, not docs.
...
**Note:** Canonical manuals live in the parent [`documentation/`](../) directory. This is the authoritative source for:
- Development guidelines
- User guides
- Planning documents
- Implementation details

See [documentation/README.md](../README.md) for the complete index.
