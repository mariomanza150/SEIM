...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "django-insecure-4x)^u)--kg0+f(pv3cohlm!me-)a#h#b!)!hmn=pof73a3k&qu")
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "debug": bool(os.getenv("DJANGO_TEMPLATE_DEBUG", False)),  # Template debugging
            "string_if_invalid": "",  # How to handle invalid variables
            "libraries": {},  # Custom template tags
        },
    },
]
