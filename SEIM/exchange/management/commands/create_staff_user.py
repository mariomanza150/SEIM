...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--institution", type=str, default="", help="Institution for the user")
        parser.add_argument("--department", type=str, default="", help="Department for the user")
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f'Successfully created {role} user "{username}" with token: {token.key}'))
    ...
    def assign_permissions(self, user, role):
        ...
        # Get permissions
        can_view_all = Permission.objects.get(codename="can_view_all_exchanges", content_type=exchange_content_type)
        can_approve = Permission.objects.get(codename="can_approve_exchange", content_type=exchange_content_type)
        can_reject = Permission.objects.get(codename="can_reject_exchange", content_type=exchange_content_type)
