...
class DocumentGenerator:
    ...
    def generate_acceptance_letter(self, exchange):
        ...
        story.append(Paragraph("International Exchange Program", self.styles["Heading2"]))
    ...
    def generate_progress_report(self, exchange):
        ...
        story.append(Paragraph(f"{exchange.first_name} {exchange.last_name}", self.styles["Heading2"]))
        story.append(Spacer(1, 0.3 * inch))
        ...
        if docs:
            ...
            story.append(Paragraph("No documents submitted yet.", self.styles["Normal"]))
    ...
    def generate_grade_sheet(self, exchange, grades_data):
        ...
        story.append(Paragraph(f"{exchange.destination_university}", self.styles["Heading2"]))
        story.append(Spacer(1, 0.3 * inch))
