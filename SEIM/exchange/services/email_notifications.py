...
class ExchangeEmailNotificationService:
    ...
    def notify_rejection(self, exchange: Exchange, reason: Optional[str] = None) -> bool:
        """
    ...
    def notify_comment_added(self, exchange: Exchange, comment_author: User, comment_text: str) -> bool:
        """
