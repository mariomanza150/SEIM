...
urlpatterns = [
    ...
    path(
        "seim/dynforms/builder/",
        AuthenticatedFormBuilder.as_view(),
        name="dynforms-builder",
    ),
    path(
        "seim/dynforms/builder/<int:pk>/",
        AuthenticatedFormBuilder.as_view(),
        name="dynforms-builder-edit",
    ),
    ...
    path(
        "", include(("internacional.urls", "internacional"), namespace="internacional")
    ),
]
