...
def compare_screenshot(
    ...
    if diff_percentage > threshold:
        ...
        print(
            f"Visual difference detected: {diff_percentage:.2%} (threshold: {threshold:.2%})"
        )
...
def update_baseline(
    name: str,
    screenshot: bytes,
    baseline_dir: str = "tests/e2e_playwright/visual/snapshots",
) -> None:
    """
...
def delete_baseline(
    name: str, baseline_dir: str = "tests/e2e_playwright/visual/snapshots"
) -> None:
    """
...
def generate_visual_report(
    results: dict, output_dir: str = "tests/e2e_playwright/visual/reports"
) -> None:
    """
