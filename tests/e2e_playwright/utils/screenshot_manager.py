...
class ScreenshotManager:
    ...
    def capture(
        self, page: Page, name: str, full_page: bool = True, element: str | None = None
    ) -> Path:
        """
    ...
    def capture_step(
        self, page: Page, test_name: str, step_name: str, full_page: bool = False
    ) -> Path:
        """
...
def capture_page_screenshot(
    page: Page, path: str, full_page: bool = True, clip: dict | None = None
) -> None:
    """
...
def create_screenshot_comparison_html(
    baseline_path: str, current_path: str, diff_path: str, output_path: str
) -> None:
    """
