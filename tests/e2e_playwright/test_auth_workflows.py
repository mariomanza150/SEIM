...
class TestAuthenticationWorkflows:
    ...
    def test_user_registration_success(self, page, base_url):
        ...
        assert "register" not in page.url or auth_page.is_visible(
            auth_page.REGISTER_SUCCESS_MESSAGE
        )
    ...
    def test_user_login_valid_credentials(self, page, base_url, test_users):
        ...
        auth_page.login(
            student_creds["email"], student_creds["password"]
        )  # Vue uses email
