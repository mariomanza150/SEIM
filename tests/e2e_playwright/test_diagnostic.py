...
def test_inspect_login_page(page: Page, base_url: str):
    ...
    # Take screenshot
    page.screenshot(
        path="tests/e2e_playwright/screenshots/login_page_inspect.png", full_page=True
    )
    ...
    for i, inp in enumerate(inputs):
        ...
        print(
            f"  {i + 1}. type={input_type}, name={input_name}, id={input_id}, class={input_class[:50]}"
        )
...
def test_inspect_homepage(page: Page, base_url: str):
    ...
    # Take screenshot
    page.screenshot(
        path="tests/e2e_playwright/screenshots/homepage_inspect.png", full_page=True
    )
