...
class ApplicationFormPage(BasePage):
    ...
    PERSONAL_STATEMENT = (
        '[data-testid="personal-statement"], textarea[name="personal_statement"]'
    )
    ACADEMIC_BACKGROUND = (
        '[data-testid="academic-background"], textarea[name="academic_background"]'
    )
    LANGUAGE_PROFICIENCY = (
        '[data-testid="language-proficiency"], textarea[name="language_proficiency"]'
    )
