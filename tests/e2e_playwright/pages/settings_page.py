...
class SettingsPage(BasePage):
    ...
    IN_APP_NOTIFICATIONS_CHECKBOX = (
        '[data-testid="in-app-notifications"], input[name="in_app_notifications"]'
    )

    # Privacy settings
    PROFILE_VISIBILITY_SELECT = (
        '[data-testid="profile-visibility"], select[name="profile_visibility"]'
    )
    ...
    CHANGE_PASSWORD_BUTTON = (
        '[data-testid="change-password"], button:has-text("Change Password")'
    )
    DELETE_ACCOUNT_BUTTON = (
        '[data-testid="delete-account"], button:has-text("Delete Account")'
    )
