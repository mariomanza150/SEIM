...
BASE_URL = os.environ.get(
    "BASE_URL", "http://web:8000" if IS_DOCKER else "http://localhost:8000"
)
...
CONTEXT_CONFIG: dict[str, Any] = {
    ...
    "record_video_dir": VIDEO_CONFIG["path"]
    if VIDEO_CONFIG["enabled"] != "off"
    else None,
...
VISUAL_REGRESSION_CONFIG = {
    "threshold": float(
        os.environ.get("VISUAL_THRESHOLD", 0.1)
    ),  # 10% difference allowed
