...
class TestWebSocketNotifications:
    ...
    async def test_websocket_ping_pong(self):
        ...
        # Create test user
        user = await User.objects.acreate(
            username="testuser5", email="test5@example.com"
        )
    ...
    async def test_websocket_error_handling(self):
        ...
        # Create test user
        user = await User.objects.acreate(
            username="testuser6", email="test6@example.com"
        )
...
class TestNotificationServiceBroadcasting:
    ...
    def test_bulk_notification_broadcasting(self):
        ...
        notifications = NotificationService.send_bulk_notifications(
            recipients=users, title="Bulk Test", message="Testing bulk notifications"
        )
