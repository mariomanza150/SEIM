...
class TestDynamicFormRendering(TestCase):
    ...
    def test_render_boolean_field(self):
        ...
        form_type = FormType.objects.create(
            ...
            schema={
                "properties": {
                    "agree_terms": {"type": "boolean", "title": "I agree to terms"}
                }
            },
            created_by=self.user,
        )
    ...
    def test_form_with_no_schema(self):
        ...
        form_type = FormType.objects.create(
            name="Empty Form", schema={}, created_by=self.user
        )
...
class TestDynamicFormValidation(TestCase):
    ...
    def test_invalid_email_format(self):
        ...
        form = DynamicFormFromSchema(
            self.form_type,
            data={"name": "John Doe", "email": "invalid-email", "age": 25},
        )
...
class TestDynamicFormSubmission(TestCase):
    ...
    def test_submission_validation_success(self):
        ...
        responses = {"motivation": "Valid motivation", "experience": "Valid experience"}
    ...
    def test_get_user_submissions(self):
        ...
        submissions = FormSubmissionService.get_user_submissions(
            form_type=self.form_type, user=self.user
        )
        ...
        self.form_type = FormType.objects.create(
            ...
            schema={
                "properties": {
                    ...
                    "motivation": {"type": "string", "title": "Motivation Statement"},
                    "previous_exchanges": {
                        "type": "integer",
...
class TestDynamicFormAPIEndpoints(TestCase):
    ...
    def test_form_type_created_by_assignment(self):
        ...
        new_form = FormType.objects.create(
            name="Created Form", form_type="custom", schema={}, created_by=self.admin
        )
...
class TestDynamicFormWithApplication(TestCase):
    ...
    def test_application_with_dynamic_form(self):
        ...
        self.assertEqual(
            self.application.program.application_form.name, "Exchange Application Form"
        )
    ...
    def test_update_existing_form_submission(self):
        ...
        submission_1 = ApplicationService.process_dynamic_form_submission(
            application=self.application, form_data=form_data_1, user=self.student
        )
        ...
        submission_2 = ApplicationService.process_dynamic_form_submission(
            application=self.application, form_data=form_data_2, user=self.student
        )
    ...
    def test_form_submission_without_dynamic_form(self):
        ...
        form_data = {"df_some_field": "Some value"}
...
class TestDynamicFormFieldTypes(TestCase):
    ...
    def test_string_field_type(self):
        ...
        form_type = FormType.objects.create(
            name="String Test",
            schema={
                "properties": {"text_field": {"type": "string", "title": "Text Field"}}
            },
            created_by=self.user,
        )
    ...
    def test_number_field_type(self):
        ...
        form_type = FormType.objects.create(
            name="Number Test",
            schema={"properties": {"score": {"type": "number", "title": "Score"}}},
            created_by=self.user,
        )
        ...
        self.assertIsInstance(
            form.fields["score"], (forms.FloatField, forms.DecimalField)
        )
...
class TestDynamicFormInteraction(TestCase):
    ...
    def test_form_submission_creates_timeline_event(self):
        ...
        form_type = FormType.objects.create(
            ...
            form_type="application",
            schema={
                "properties": {"field1": {"type": "string", "title": "Field 1"}},
                "required": ["field1"],
            },
            created_by=self.student,
        )
        ...
        # Submit form
        form_data = {"df_field1": "Test value"}

        ApplicationService.process_dynamic_form_submission(
            application=application, form_data=form_data, user=self.student
        )

        # Check timeline event created
        timeline_events = TimelineEvent.objects.filter(
            application=application, event_type="form_submitted"
        )
    ...
    def test_form_field_prefix_handling(self):
        ...
        form_type = FormType.objects.create(
            ...
            form_type="application",
            schema={
                "properties": {"test_field": {"type": "string", "title": "Test Field"}},
                "required": ["test_field"],
            },
            created_by=self.student,
        )
        ...
        form_data = {"df_test_field": "Test value", "non_df_field": "Should be ignored"}
