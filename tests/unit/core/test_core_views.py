...
class TestDynamicFormFromSchemaCoreViews(TestCase):
    ...
    def test_string_field_generation(self):
        ...
        form_type = FormType.objects.create(name="Test Form", schema=schema)
    ...
    def test_number_field_generation(self):
        ...
        schema = {"properties": {"amount": {"type": "number", "title": "Amount"}}}
    ...
    def test_array_choice_field_generation(self):
        ...
        form_type = FormType.objects.create(name="Choice Form", schema=schema)
    ...
    def test_unknown_field_type_defaults_to_char(self):
        ...
        schema = {"properties": {"custom": {"type": "unknown_type", "title": "Custom"}}}

        form_type = FormType.objects.create(name="Unknown Form", schema=schema)
    ...
    def test_field_with_description(self):
        ...
        form_type = FormType.objects.create(name="Help Text Form", schema=schema)
    ...
    def test_field_without_title_uses_field_name(self):
        ...
        form_type = FormType.objects.create(name="Auto Title Form", schema=schema)
    ...
    def test_multiple_fields_mixed_types(self):
        ...
        form_type = FormType.objects.create(name="Mixed Form", schema=schema)
    ...
    def test_form_with_empty_schema(self):
        ...
        form_type = FormType.objects.create(name="Empty Form", schema={})
    ...
    def test_form_with_no_properties(self):
        ...
        form_type = FormType.objects.create(
            name="No Props Form", schema={"required": []}
        )
