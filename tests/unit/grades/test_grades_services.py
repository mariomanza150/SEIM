...
class TestGradeTranslationService(TestCase):
    ...
    def test_translate_grade_with_direct_translation(self):
        ...
        GradeTranslation.objects.create(
            source_grade=self.us_a, target_grade=self.ects_a, confidence=1.0
        )
    ...
    def test_translate_grade_source_not_found(self):
        ...
        with self.assertRaises(ObjectDoesNotExist):
            GradeTranslationService.translate_grade(
                source_grade_value_id=fake_id, target_scale_id=str(self.ects_scale.id)
            )
    ...
    def test_translate_grade_target_scale_not_found(self):
        ...
        with self.assertRaises(ObjectDoesNotExist):
            GradeTranslationService.translate_grade(
                source_grade_value_id=str(self.us_a.id), target_scale_id=fake_id
            )
    ...
    def test_convert_gpa_to_scale_exact_match(self):
        ...
        result = GradeTranslationService.convert_gpa_to_scale(
            gpa_value=3.0, target_scale_id=str(self.us_scale.id)
        )
    ...
    def test_convert_gpa_to_scale_not_found(self):
        ...
        with self.assertRaises(ObjectDoesNotExist):
            GradeTranslationService.convert_gpa_to_scale(
                gpa_value=3.0, target_scale_id=fake_id
            )
    ...
    def test_convert_gpa_to_scale_empty_scale(self):
        ...
        result = GradeTranslationService.convert_gpa_to_scale(
            gpa_value=3.0, target_scale_id=str(empty_scale.id)
        )
    ...
    def test_get_available_translations_multiple(self):
        ...
        GradeTranslation.objects.create(
            source_grade=self.us_a, target_grade=self.ects_a, confidence=0.95
        )

        GradeTranslation.objects.create(
            source_grade=self.us_a, target_grade=uk_first, confidence=0.90
        )
    ...
    def test_suggest_translation_calculates_confidence(self):
        ...
        translation = GradeTranslationService.suggest_translation(
            source_grade_id=str(self.us_a.id), target_grade_id=str(self.ects_a.id)
        )
        ...
        translation2 = GradeTranslationService.suggest_translation(
            source_grade_id=str(self.us_a.id), target_grade_id=str(self.ects_b.id)
        )
    ...
    def test_suggest_translation_same_scale(self):
        ...
        with self.assertRaises(ValidationError):
            GradeTranslationService.suggest_translation(
                source_grade_id=str(self.us_a.id), target_grade_id=str(self.us_b.id)
            )
    ...
    def test_suggest_translation_grade_not_found(self):
        ...
        with self.assertRaises(ObjectDoesNotExist):
            GradeTranslationService.suggest_translation(
                source_grade_id=fake_id, target_grade_id=str(self.ects_a.id)
            )
    ...
    def test_find_closest_grade_exact_match(self):
        ...
        result = GradeTranslationService._find_closest_grade(
            numeric_value=4.0, grade_scale=self.us_scale
        )
    ...
    def test_find_closest_grade_empty_scale(self):
        ...
        result = GradeTranslationService._find_closest_grade(
            numeric_value=5.0, grade_scale=empty_scale
        )
    ...
    def test_convert_gpa_boundary_values(self):
        ...
        result_min = GradeTranslationService.convert_gpa_to_scale(
            gpa_value=0.0, target_scale_id=str(self.us_scale.id)
        )
        self.assertIsNotNone(result_min)

        # Test max value (4.0)
        result_max = GradeTranslationService.convert_gpa_to_scale(
            gpa_value=4.0, target_scale_id=str(self.us_scale.id)
        )
    ...
    def test_find_closest_grade_with_ties(self):
        ...
        result = GradeTranslationService._find_closest_grade(
            numeric_value=2.5, grade_scale=self.us_scale
        )
