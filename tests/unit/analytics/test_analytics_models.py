...
class TestReport:
    def test_report_creation(self):
        ...
        report = Report.objects.create(
            name="Test Report", description="A test report", created_by=user
        )
    ...
    def test_report_without_created_by(self):
        ...
        report = Report.objects.create(
            name="Anonymous Report", description="A report without creator"
        )
...
class TestMetric:
    def test_metric_creation(self):
        ...
        report = Report.objects.create(name="Test Report")
        metric = Metric.objects.create(name="test_metric", value=42.5, report=report)
    ...
    def test_metric_str_method(self):
        ...
        report = Report.objects.create(name="Test Report")
        metric = Metric.objects.create(name="test_metric", value=100.0, report=report)
...
class TestDashboardConfig:
    def test_dashboard_config_creation(self):
        ...
        dashboard_config = DashboardConfig.objects.create(user=user, config=config_data)
    ...
    def test_dashboard_config_empty_config(self):
        ...
        user = User.objects.create_user(username="testuser", email="test@example.com")
        dashboard_config = DashboardConfig.objects.create(user=user, config={})
