...
class TestAnalyticsService:
    ...
    def test_get_application_statistics(self):
        ...
        status_draft, _ = ApplicationStatus.objects.get_or_create(
            name="draft", defaults={"order": 1}
        )
        status_submitted, _ = ApplicationStatus.objects.get_or_create(
            name="submitted", defaults={"order": 2}
        )
        status_approved, _ = ApplicationStatus.objects.get_or_create(
        ...
        Application.objects.create(
            student=user1, program=program2, status=status_submitted
        )
        Application.objects.create(
            student=user2, program=program1, status=status_approved
        )
    ...
    def test_get_timeline_statistics(self):
        ...
        app1 = Application.objects.create(
            student=user, program=program, status=status_obj
        )
        app1.created_at = now
        app1.save()
    ...
    def test_get_conversion_rates(self):
        ...
        Application.objects.create(
            student=user1, program=program, status=status_submitted
        )
        Application.objects.create(
            student=user2, program=program, status=status_approved
        )
    ...
    def test_get_custom_analytics(self):
        ...
        # Test custom query
        result = service.get_custom_analytics(
            "SELECT COUNT(*) as count FROM exchange_application"
        )
