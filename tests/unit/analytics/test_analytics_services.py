...
class TestAnalyticsService:
    ...
    def test_get_user_demographics(self, user):
        ...
        assert (
            "unknown" in demographics["users_by_role"]
            or "student" in demographics["users_by_role"]
        )
    ...
    def test_get_cached_metrics_with_fallback_program_metrics(
        self, programs, applications
    ):
        """Test getting cached program metrics with fallback."""
        metrics = AnalyticsService.get_cached_metrics_with_fallback(
            "program", program_id=programs["active"].id
        )
    ...
    def test_get_program_performance_with_inactive_programs(
        self, programs, applications
    ):
    ...
    def test_analytics_with_multiple_application_statuses(
    ...
    def test_get_system_health_with_large_dataset(
        self, user, programs, application_statuses
    ):
    ...
    def test_application_statistics_distinct_users(
        self, user, another_user, programs, application_statuses
    ):
    ...
    def test_conversion_rates_with_complex_funnel(
        self, user, programs, application_statuses
    ):
