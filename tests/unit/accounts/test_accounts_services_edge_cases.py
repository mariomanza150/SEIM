...
class TestUserRegistrationEdgeCases(TestCase):
    ...
    def test_register_with_minimum_valid_data(self):
        ...
        user = User.objects.create_user(
            username="minuser", email="min@test.com", password="pass123"
        )
    ...
    def test_register_with_unicode_username(self):
        ...
        user = User.objects.create_user(
            username=unicode_username, email="unicode@test.com", password="testpass123"
        )
    ...
    def test_duplicate_username_prevention(self):
        ...
        with self.assertRaises(Exception):  # IntegrityError expected
            User.objects.create_user(
                username="duplicate", email="second@test.com", password="testpass123"
            )
    ...
    def test_duplicate_email_allowed(self):
        ...
        User.objects.create_user(
            username="user1", email="same@test.com", password="testpass123"
        )
    ...
    def test_password_with_null_bytes(self):
        ...
        user = User.objects.create_user(
            username="nullbyte", email="null@test.com", password=password
        )
...
class TestRoleAssignmentEdgeCases(TestCase):
    ...
    def test_user_with_no_roles(self):
        ...
        user = User.objects.create_user(
            username="noroles", email="noroles@test.com", password="testpass123"
        )
    ...
    def test_user_with_multiple_roles(self):
        ...
        user = User.objects.create_user(
            username="multirole", email="multi@test.com", password="testpass123"
        )
...
class TestAuthenticationEdgeCases(TestCase):
    ...
    def test_login_with_wrong_password(self):
        ...
        user = User.objects.create_user(
            username="testuser", email="test@test.com", password="correctpass"
        )
    ...
    def test_case_sensitive_username(self):
        ...
        User.objects.create_user(
            username="TestUser", email="test1@test.com", password="testpass123"
        )

        # Different case should create different user
        User.objects.create_user(
            username="testuser", email="test2@test.com", password="testpass123"
        )
