...
class TestPasswordReset(TestCase):
    ...
    def test_reset_password_success(self, mock_notification):
        ...
        updated_user = AccountService.reset_password(
            email="test@test.com", token=token, new_password="newpass123"
        )
    ...
    def test_reset_password_invalid_email(self):
        ...
        with self.assertRaises(ValueError) as context:
            AccountService.reset_password(
                email="wrong@test.com", token="any_token", new_password="newpass123"
            )
    ...
    def test_reset_password_invalid_token(self):
        ...
        with self.assertRaises(ValueError) as context:
            AccountService.reset_password(
                email="test@test.com", token="wrong_token", new_password="newpass123"
            )
...
class TestPasswordChange(TestCase):
    ...
    def test_change_password_success(self, mock_notification):
        ...
        updated_user = AccountService.change_password(
            self.user, old_password="oldpass123", new_password="newpass123"
        )
    ...
    def test_change_password_wrong_old_password(self):
        ...
        with self.assertRaises(ValueError) as context:
            AccountService.change_password(
                self.user, old_password="wrongpass", new_password="newpass123"
            )
    ...
    def test_change_password_same_as_old(self):
        ...
        updated_user = AccountService.change_password(
            self.user, old_password="oldpass123", new_password="oldpass123"
        )
