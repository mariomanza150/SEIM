...
class NotificationServiceTestCase(TestCase):
    ...
    def setUp(self):
        ...
        Profile.objects.get_or_create(
            user=self.student, defaults={"gpa": 3.5, "language": "English"}
        )
        Profile.objects.get_or_create(
            user=self.coordinator, defaults={"gpa": 3.8, "language": "English"}
        )
        Profile.objects.get_or_create(
            user=self.admin, defaults={"gpa": 4.0, "language": "English"}
        )
    ...
    def test_send_notification_email(self):
        ...
        with patch(
            "notifications.services.send_notification_by_id.delay"
        ) as mock_send_email:
            notification = NotificationService.send_notification(
                recipient=self.student,
    ...
    def test_send_notification_to_role(self):
        ...
        with patch(
            "notifications.services.NotificationService.send_bulk_notifications"
        ) as mock_bulk:
