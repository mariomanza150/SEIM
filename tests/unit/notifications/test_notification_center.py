...
class TestNotificationCenterAPI:
    ...
    def test_filter_unread_notifications(
        self, api_client_authenticated_student, notifications
    ):
    ...
    def test_filter_by_category(self, api_client_authenticated_student, notifications):
        ...
        response = api_client_authenticated_student.get(
            "/api/notifications/?category=success"
        )
    ...
    def test_user_only_sees_own_notifications(
        self, api_client_authenticated_student, other_user_notifications
    ):
    ...
    def test_notifications_ordered_by_sent_at(
        self, api_client_authenticated_student, notifications
    ):
    ...
    def test_notification_pagination(
        self, api_client_authenticated_student, many_notifications
    ):
