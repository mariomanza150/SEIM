...
class TestFormTypeSerializer(TestCase):
    ...
    def test_validate_schema_invalid_non_dict(self):
        ...
        data = {"name": "New Form", "form_type": "application", "schema": "not a dict"}
    ...
    def test_validate_ui_schema_invalid_non_dict(self):
        ...
        self.assertIn(
            "must be a valid JSON object", str(serializer.errors["ui_schema"])
        )
    ...
    def test_update_form_type(self):
        ...
        data = {"name": "Updated Form", "description": "Updated description"}

        serializer = FormTypeSerializer(
            instance=self.form_type, data=data, partial=True
        )
        self.assertTrue(serializer.is_valid())
...
class TestFormSubmissionSerializer(TestCase):
    ...
    def test_validate_responses_invalid_non_dict(self):
        ...
        data = {"form_type": self.form_type.id, "responses": "not a dict"}

        serializer = FormSubmissionSerializer(data=data)
        self.assertFalse(serializer.is_valid())
        self.assertIn("responses", serializer.errors)
        self.assertIn(
            "must be a valid JSON object", str(serializer.errors["responses"])
        )
    ...
    def test_validate_no_required_fields_defined(self):
        ...
        data = {"form_type": form_type_no_required.id, "responses": {}}
