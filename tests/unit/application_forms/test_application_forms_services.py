...
class TestDynamicFormFromSchema(TestCase):
    ...
    def test_empty_schema(self):
        ...
        form_type = FormType.objects.create(
            name="Empty Form", form_type="custom", schema={}
        )
    ...
    def test_string_field(self):
        ...
        form_type = FormType.objects.create(
            name="String Form", form_type="custom", schema=schema
        )
    ...
    def test_email_field(self):
        ...
        form_type = FormType.objects.create(name="Email Form", schema=schema)
    ...
    def test_url_field(self):
        ...
        form_type = FormType.objects.create(name="URL Form", schema=schema)
    ...
    def test_date_field(self):
        ...
        form_type = FormType.objects.create(name="Date Form", schema=schema)
    ...
    def test_datetime_field(self):
        ...
        form_type = FormType.objects.create(name="DateTime Form", schema=schema)
    ...
    def test_enum_field(self):
        ...
        form_type = FormType.objects.create(name="Enum Form", schema=schema)
    ...
    def test_textarea_field(self):
        ...
        form_type = FormType.objects.create(name="Textarea Form", schema=schema)
    ...
    def test_integer_field(self):
        ...
        form_type = FormType.objects.create(name="Integer Form", schema=schema)
    ...
    def test_number_field(self):
        ...
        form_type = FormType.objects.create(name="Number Form", schema=schema)
    ...
    def test_boolean_field(self):
        ...
        schema = {"properties": {"agreed": {"type": "boolean", "title": "I Agree"}}}

        form_type = FormType.objects.create(name="Boolean Form", schema=schema)
    ...
    def test_array_field(self):
        ...
        schema = {
            "properties": {
                "interests": {
                    "type": "array",
                    "items": {"enum": ["sports", "music", "art", "science"]},
                    "title": "Interests",
                }
            }
        }

        form_type = FormType.objects.create(name="Array Form", schema=schema)
    ...
    def test_multiple_fields(self):
        ...
        form_type = FormType.objects.create(name="Multi Form", schema=schema)
...
class TestFormSubmissionService(TestCase):
    ...
    def setUp(self):
        ...
        self.form_type = FormType.objects.create(
            name="Test Form", form_type="custom", schema=self.schema
        )

    def test_create_submission_success(self):
        """Test successful submission creation."""
        responses = {"name": "John Doe", "email": "john@example.com", "age": 25}

        submission = FormSubmissionService.create_submission(
            form_type=self.form_type, submitted_by=self.user, responses=responses
        )
    ...
    def test_create_submission_with_application(self):
        ...
        application = Application.objects.create(
            student=self.user, program=program, status=status
        )
    ...
    def test_validate_responses_success(self):
        ...
        result = FormSubmissionService.validate_responses(
            form_type=self.form_type, responses=responses
        )
    ...
    def test_validate_responses_number_type(self):
        ...
        schema = {"properties": {"gpa": {"type": "number"}}}
        form_type = FormType.objects.create(name="Number Form", schema=schema)

        # Should fail with string
        with self.assertRaises(ValidationError):
            FormSubmissionService.validate_responses(
                form_type=form_type, responses={"gpa": "three point five"}
            )

    def test_validate_responses_boolean_type(self):
        """Test validation for boolean type."""
        schema = {"properties": {"agreed": {"type": "boolean"}}}
        form_type = FormType.objects.create(name="Bool Form", schema=schema)

        # Should fail with non-boolean
        with self.assertRaises(ValidationError):
            FormSubmissionService.validate_responses(
                form_type=form_type, responses={"agreed": "yes"}
            )
    ...
    def test_validate_responses_array_type(self):
        ...
        with self.assertRaises(ValidationError):
            FormSubmissionService.validate_responses(
                form_type=form_type, responses={"tags": "tag1,tag2"}
            )
    ...
    def test_validate_responses_no_schema(self):
        ...
        result = FormSubmissionService.validate_responses(
            form_type=form_type, responses=responses
        )
    ...
    def test_get_user_submissions_all(self):
        ...
        FormSubmissionService.create_submission(
            form_type=self.form_type, submitted_by=self.user, responses=responses1
        )

        FormSubmissionService.create_submission(
            form_type=self.form_type, submitted_by=self.user, responses=responses2
        )
    ...
    def test_get_user_submissions_filtered_by_form_type(self):
        ...
        form_type2 = FormType.objects.create(
            name="Another Form", schema={"properties": {"field": {"type": "string"}}}
        )
        ...
        FormSubmissionService.create_submission(
            form_type=form_type2, submitted_by=self.user, responses={"field": "value"}
        )

        submissions = FormSubmissionService.get_user_submissions(
            self.user, form_type=self.form_type
        )
