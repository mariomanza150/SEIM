...
class TestLanguageSwitching(TestCase):
    ...
    def test_language_switch_via_post(self):
        ...
        response = self.client.post("/i18n/setlang/", {"language": "es", "next": "/"})
    ...
    def test_invalid_language_code(self):
        ...
        response = self.client.post(
            "/i18n/setlang/", {"language": "invalid", "next": "/"}
        )
...
class TestPluralForms(TestCase):
    ...
    def test_plural_forms_spanish(self):
        ...
        with translation.override("es"):
            ...
            # Singular
            ngettext("%(count)d application", "%(count)d applications", 1) % {
                "count": 1
            }
            # Note: This would need actual translations in .po file

            # Plural
            ngettext("%(count)d application", "%(count)d applications", 5) % {
                "count": 5
            }
    ...
    def test_plural_forms_french(self):
        ...
        with translation.override("fr"):
            ...
            ngettext("%(count)d application", "%(count)d applications", 0) % {
                "count": 0
            }
...
class TestUserLanguagePreference(TestCase):
    ...
    def test_language_preference_in_session(self):
        ...
        # Set language
        response = self.client.post(
            "/i18n/setlang/", {"language": "es", "next": "/dashboard/"}
        )
