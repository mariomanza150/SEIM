...
urlpatterns = [
    ...
    path(
        "cgri/",
        RedirectView.as_view(url="/internacional/institucional/", permanent=True),
        name="cgri_redirect",
    ),
    path(
        "cgri/about/",
    ...
    path(
        "cgri/team/",
        RedirectView.as_view(
            url="/internacional/institucional/equipo/", permanent=True
        ),
    ...
    path(
        "cgri/agreements/",
        RedirectView.as_view(
            url="/internacional/institucional/convenios/", permanent=True
        ),
    ...
    path(
        "cgri/accreditations/",
        RedirectView.as_view(
            url="/internacional/institucional/acreditaciones/", permanent=True
        ),
    ...
    path(
        "movilidad/requirements/",
        RedirectView.as_view(
            url="/internacional/movilidad-estudiantil/requisitos/", permanent=True
        ),
    ...
    path(
        "movilidad/documents/",
        RedirectView.as_view(
            url="/internacional/movilidad-estudiantil/documentacion/", permanent=True
        ),
    ...
    path(
        "movilidad/benefits/",
        RedirectView.as_view(
            url="/internacional/movilidad-estudiantil/beneficios/", permanent=True
        ),
    ...
    path(
        "movilidad/calendar/",
        RedirectView.as_view(
            url="/internacional/movilidad-estudiantil/calendario/", permanent=True
        ),
