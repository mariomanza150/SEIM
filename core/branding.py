...
DEFAULT_INSTITUTION: dict[str, str] = {
    ...
    "INSTITUTION_EMAIL": "relaciones.internacionales@uadec.edu.mx",
    "INSTITUTION_PHONE": "844 415 3077 | 844 416 9995",
    "INSTITUTION_ADDRESS": (
        "Lic. Salvador González Lobo s/n<br>"
        "Col. República Oriente<br>Saltillo, Coahuila, México<br>C.P. 25280"
    ),
    "INSTITUTION_LOGO_URL": "/static/uadec/logos/institution-logo.png",
    ...
    "BRAND_PRIMARY": "#2E5790",
    "BRAND_PRIMARY_LIGHT": "#3251AC",
    "BRAND_PRIMARY_DARK": "#1E3A5F",
    "BRAND_ACCENT": "#BF9B4C",
    "BRAND_ACCENT_LIGHT": "#EDB621",
    "BRAND_ACCENT_DARK": "#A6863D",
    "BRAND_NAVY": "#1E3A5F",
    "BRAND_ORANGE": "#E67E22",
    "BRAND_TEXT": "#2C3E50",
}
...
def apply_institution_tokens(text: str, brand: Mapping[str, Any]) -> str:
    ...
    replacements = (
        ...
        (_LEGACY_ADDRESS, brand.get("address") or ""),
        (
