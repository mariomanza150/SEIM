...
class HasPermission(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return PermissionManager.user_has_permission(request.user, self.permission_name)
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if "own" in self.permission_name:
            ...
            return PermissionManager.user_has_permission(request.user, any_permission)
...
class IsStudentOrReadOnly(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        if request.method == "POST":
            return hasattr(request.user, "has_any_role") and request.user.has_any_role(
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if hasattr(request.user, "has_any_role") and request.user.has_any_role(
            ["coordinator", "admin"]
        ):
            return True
