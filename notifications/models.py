...
class Notification(UUIDModel, TimeStampedModel):
    ...
    class Meta:
        indexes = [
            ...
            models.Index(
                fields=["recipient", "-sent_at"], name="notif_recipient_sent_idx"
            ),
...
class Reminder(UUIDModel, TimeStampedModel):
    ...
    event_title = models.CharField(
        max_length=255, help_text="Title/description of the event"
    )
    remind_at = models.DateTimeField(help_text="When to send the reminder")
    sent = models.BooleanField(
        default=False, help_text="Whether the reminder has been sent"
    )
