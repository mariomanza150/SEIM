...
class NotificationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Action", {"fields": ("action_url", "action_text"), "classes": ("collapse",)}),
        ("Status", {"fields": ("is_read", "sent_at")}),
...
class ReminderAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("user", "event_type", "event_id", "event_title")}),
        ("Reminder", {"fields": ("remind_at", "sent", "notification")}),
