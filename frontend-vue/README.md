...
Modern Vue.js 3 SPA frontend for the Student Exchange Information Management (SEIM) system. Served at `/seim/`. Remaining Django surfaces: [docs/notes/SPA_VS_LEGACY.md](../docs/notes/SPA_VS_LEGACY.md).
