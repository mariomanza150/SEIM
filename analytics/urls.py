...
router.register(
    r"admindashboard", views.AdminDashboardViewSet, basename="admindashboard"
)
...
urlpatterns = [
    ...
    path(
        ...
        views.application_statistics_view,
        name="application_statistics",
    ),
    path(
        "program-statistics/", views.program_statistics_view, name="program_statistics"
    ),
    ...
    path(
        ...
        views.api_application_statistics,
        name="api_application_statistics",
    ),
    path(
        "api/program-statistics/",
        views.api_program_statistics,
        name="api_program_statistics",
    ),
...
urlpatterns += [
    ...
    path(
        ...
        views.application_analytics_view,
        name="application-analytics",
    ),
    path(
        "document-analytics/", views.document_analytics_view, name="document-analytics"
    ),
    path(
        "notification-analytics/",
        views.notification_analytics_view,
