...
```
Looking at the SEIM backlog (docs/backlog.md), which features 
...
- `docs/business_rules.md` - Business logic rules
...
- `docs/user_stories.md` - User requirements
- `docs/architectural_decisions.md` - Design decisions
...
```
Review the SEIM backlog (docs/backlog.md) and create an 
