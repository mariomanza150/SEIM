...
- **docs/README.md**: Complete rewrite to reflect actual structure, removed broken links
...
- **Easier navigation**: Clear documentation index in docs/README.md
