...
- `CLEANUP_CHANGELOG.md` → Move to `docs/archive/`
- `COMPLETE_VERIFICATION_SUMMARY.md` → Move to `docs/archive/`
- `VERIFICATION_SUMMARY.md` → Move to `docs/archive/`
- `FRONTEND_VERIFICATION_REPORT.md` → Move to `docs/archive/`
- `FINAL_PLAN_COMPLETION_REPORT.md` → Move to `docs/archive/`
...
- [ ] Update `docs/README.md` to reflect structure
