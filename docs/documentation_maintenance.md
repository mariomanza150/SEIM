...
- **Code Documentation**: `docs/generated/code_documentation.md`
- **Database Schema**: `docs/generated/database_schema.md`
- **Sphinx HTML**: `docs/sphinx/build/html/`
...
```bash
mkdir -p docs/archive/session_YYYY_MM_DD
```

2. **Move Files**

```bash
mv FILE.md docs/archive/session_YYYY_MM_DD/
```
...
Update `docs/archive/README.md` with new archive entry.
...
- **Store organized**: In `docs/images/`
...
2. **Check recent changes**: `git log -- docs/`
