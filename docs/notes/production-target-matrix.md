...
| **Restore testing** | Run a **quarterly** restore drill (DB + sample media). Align operational steps with [docs/deployment.md](../docs/deployment.md) backup sections and `make prod-backup` where applicable. |
...
5. **Virus scan:** Run **ClamAV** (or your policy) on ingested files before marking them accepted (see [docs/virus_scanner_setup.md](../docs/virus_scanner_setup.md)).
