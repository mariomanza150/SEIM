...
**Note:** This directory is the working-notes subtree of [`docs/`](../README.md). How notes relate to manuals: [`notes/README.md`](README.md). `documents/` is a Django app, not docs.

### Core Documentation

- [Project Overview](./project-overview.md) - Executive summary and high-level architecture
- [Source Tree Analysis](./source-tree-analysis.md) - Annotated directory structure
- [Architecture](../architecture.md) - Maintained system architecture guide
...
- [UX good-to-haves](./ux-good-to-haves.md) - Ranked polish backlog (density, canonical SPA, a11y pass)
...
**Note:** Canonical manuals live in the parent [`docs/`](../) directory. This is the authoritative source for:
- Development guidelines
- User guides
- Planning documents
- Implementation details

See [docs/README.md](../README.md) for the complete index.
...
**UI-only features:**
→ Reference: `docs/architecture.md`, `component-inventory.md`

**API/Backend features:**
→ Reference: `docs/architecture.md`, `api-contracts.md`, `data-models.md`

**Full-stack features:**
→ Reference: All architecture docs

**Deployment changes:**
→ Reference: `docs/developer_guide.md` and `docs/deployment.md`
