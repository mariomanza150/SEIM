...
This subtree holds generated analysis, status reports, UI audits, and Vue/CMS working papers. It is part of the **`docs/`** source of truth.
...
Do not treat this folder as a second official manual. Contributor guides live in the parent [`docs/`](../README.md) directory.
