...
> Hostnames such as `uadec.mx` / `internacional.uadec.mx` are **example UAdeC production values**. Substitute `INSTITUTION_WEBSITE` (and your DNS) when white-labeling. See [docs/white_labeling.md](../docs/white_labeling.md).
