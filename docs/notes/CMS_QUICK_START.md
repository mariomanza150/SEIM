...
> Keep this as the short operational reference for day-to-day CMS usage. For full restore/export workflows, use `CMS_RESTORE_GUIDE.md`. For broader CMS architecture and content guidance, use `docs/cms_guide.md`.
...
- **Full CMS Guide**: `docs/cms_guide.md`
