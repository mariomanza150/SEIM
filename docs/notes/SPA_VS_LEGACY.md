...
- [x] Partner portal
- [x] SPA admin: programs, catalogs, grade scales, users/roles, sessions/reminders, workflow catalogs (application statuses + notification types), forms (JSON), visual dynforms builder, data management, workflows, application edit
...
- [ ] Django admin remains the system-of-record editor for CMS leftovers and other operational models not listed above
