...
*Last updated: 2026-04-09 — `cms-public`: `seim.settings.test_cms` + **Unit Done** (9 pytest under `tests/unit/cms/`). Prior: notification routing schema v12; `settings-ui` unit Done.*
