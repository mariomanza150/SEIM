...
*Last updated: 2026-04-09 — `documents-core` unit verified (Docker documents integration + `tests/unit/documents` + checklist API; Vue document views). Smoke/browser Partial (host Playwright).*
