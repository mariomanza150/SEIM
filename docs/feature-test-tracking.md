...
| `notifications` | Notifications center, real-time, digests, routing reference | Partial | — | — | 2026-04-09 | Routing ref (schema v11, `transactional_route_keys_by_settings_category` + `ungated`): `test_routing_reference.py`, `test_notification_routing_reference_api.py`, `test_notifications_tasks.py`; Vue `NotificationRouting.spec.js`, `Settings.spec.js`. WebSocket / inbox E2E still open. |
...
*Last updated: 2026-04-09 — Notification routing **schema v11** (transactional routes by category index). Prior: `data-management` verified.*
