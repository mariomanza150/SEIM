...
def create_test_users():
    ...
    try:
        ...
        if created:
            ...
            print(
                f"ℹ️  Coordinator user already exists: {coordinator_user.username} (updated)"
            )
    except Role.DoesNotExist:
        print("⚠️  Coordinator role not found, user created without role")
    ...
    try:
        ...
        print("⚠️  Student role not found, user created without role")
    ...
    try:
        ...
        if created:
            ...
            print(
                f"ℹ️  Student2 user already exists: {student2_user.username} (updated)"
            )
    except Role.DoesNotExist:
        print("⚠️  Student role not found, user created without role")
